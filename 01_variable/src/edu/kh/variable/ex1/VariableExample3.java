...
public class VariableExample3 {
	...
	public static void main(String[] args) {
		...
		int num1;
		int Num1;
		//int Num1;	// Duplicate local variable Num1(중복되는 지역변수 Num1이 존재한다.)
					// Num1 변수가 중복이다 (에러)
		
		int abcdefg;
		int showMeTheMoney;
		int asdfkjqoiejlkdjklfkl; // 길이 제한 X
		...
		// ** 변수는 한 개의 데이터만 보관이 가능 **
		int iNum = 30;
		System.out.println(iNum);
		
		iNum = 50;
		System.out.println(iNum); // 마지막 대입하 값만 보관됨
		...
		str1 = "String도 변수 기본 자료형 변수처럼 값을 변경할 수 있습니다.";
