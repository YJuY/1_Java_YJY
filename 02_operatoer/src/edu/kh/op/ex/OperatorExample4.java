...
public class OperatorExample4 {
	...
	public static void main(String[] args) {
		...
		boolean result1 = a >= 100; // a는 100이상? ture
		boolean result2 = a % 2 == 0;	// a는 짝수인가? false;
				
		System.out.println("a는100이상이면서 짝수인가? " + (result1 && result2));
		...
		boolean result4 = b <= 10;	// b는 10 이하이가?
		
		System.out.println("b는 1부터 10 사이의 정수인가? "+  (result3 &&result4));
		
		// ||(OR) 연산자 둘 다 false 이면, 나머진 true
		// 또는 ~ 거나, ~이거나
		
		 int c = 10;
		 
		 // c는 홀수 이거나 10을 초고한 수 인가?
