...
public class StudentService {
	...
	public StudentService() {
		...
		stdList.add( new Student("김길순", 19, "서울시 중구", 'F', 75));
		stdList.add( new Student("가나다", 17, "경기도 부천시", 'M', 90));
	}
	
	/** stdList에 학생 정보 추가 메서드             # alt + shift + j
	 * @param name
	 * @param age
	 * @param address
	 * @param gender
...
//		List<Integer> test3 = new ArrayList<Integer>();
	 ...
	 * @return resultList
	 */
	public List<Student> selectStjdent1(String name) {
	 ...
	 * @return resultList
	 */
	public List<Student> selectStjdent2(String name) {
