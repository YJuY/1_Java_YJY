...
public class StudentView {
	...
	public void dispalyMenu() {
		...
		do { 
	         ...
	         try {
	        	 ...
	        	 System.out.println("[error] 입력 형식이 유호하지 않습니다.\n");
	        	 input = -1; // 첫 반복 시 잘못 입력된 경우 while문이 종료되지 않도로 하는 값 
	...
	public void selectStudent1() {
		...
		List<Student> resultList = service.selectStjdent1(name);
		
		// resultLis애 결과가 있는지 없는지 검사
	...
	public void selectStudent2() {
		...
		List<Student> resultList = service.selectStjdent2(name);
